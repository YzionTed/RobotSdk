...
//                builder.show();
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
//                RobotRaphael.move(getApplicationContext(), RobotRaphael.MOVE_BACK);
            }
        });
...
//            public void onClick(View v) {
//                RobotRaphael.move(getApplicationContext(), RobotRaphael.MOVE_FRONT);
//            }
//        });
//
//        final Button left = (Button) findViewById(R.id.goleft);
//        left.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                RobotRaphael.move(getApplicationContext(), RobotRaphael.MOVE_LEFT);
//            }
//        });
//
//        final Button right = (Button) findViewById(R.id.goright);
//        right.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                RobotRaphael.move(getApplicationContext(), RobotRaphael.MOVE_RIGHT);
//            }
//        });
//
//        final Button openProjector = (Button) findViewById(R.id.openProjector);
//        openProjector.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                RobotRaphael.openProjector(getApplicationContext());
//            }
//        });
//
//        final Button closeProjector = (Button) findViewById(R.id.closeProjector);
//        closeProjector.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                RobotRaphael.closeProjector(getApplicationContext());
//            }
//        });
    }
}
